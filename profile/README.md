...
[![built with Rust](https://img.shields.io/badge/built%20with-Rust-a2402a?logo=rust&logoColor=fffdf8&labelColor=0e3a5f)](https://github.com/Captain-Food/captain-food)
[![license: Coopyleft](https://img.shields.io/badge/license-Coopyleft%20%28AGPL--3.0%20based%29-e0a12b?labelColor=0e3a5f)](https://github.com/Captain-Food/captain-food/blob/main/LICENSE.md)

</div>

## The mission

<img src="https://raw.githubusercontent.com/Captain-Food/captain-food/main/.github/assets/captain.png" align="right" width="170" alt="The Captain — a mustachioed chef-admiral wielding a golden fork">
...
| 🧭 [`captain-food`](https://github.com/Captain-Food/captain-food) | the platform — specs, backend, and the whole spec-driven build |
| 🗺️ [`captain-food.github.io`](https://github.com/Captain-Food/captain-food.github.io) | the sources of the landing page |
...
[`LICENSE.md`](https://github.com/Captain-Food/captain-food/blob/main/LICENSE.md).
